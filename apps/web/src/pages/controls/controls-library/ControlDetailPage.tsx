          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => toast.info("This feature is coming soon")}>Copy ID</DropdownMenuItem>
                <DropdownMenuItem onClick={() => toast.info("This feature is coming soon")}>Bookmark</DropdownMenuItem>
                <DropdownMenuItem onClick={() => toast.info("This feature is coming soon")}>Share</DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => toast.info("Export coming soon")}>Export PDF</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        }
