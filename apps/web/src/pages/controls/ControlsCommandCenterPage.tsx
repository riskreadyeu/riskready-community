    ...
    <div className="space-y-6 animate-slide-up">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" className="gap-2" onClick={() => toast.info("Scheduling coming soon")}>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem className="gap-2" onClick={() => toast.info("Export coming soon")}>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem className="gap-2" onClick={() => toast.info("This feature is coming soon")}>
                <Plus className="w-4 h-4" />
                Create Control
              </DropdownMenuItem>
              <DropdownMenuItem className="gap-2" onClick={() => toast.info("This feature is coming soon")}>
