    ...
    <div className="space-y-8 pb-8">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" className="gap-2 rounded-lg bg-transparent" onClick={() => toast.info("Scheduling coming soon")}>
                    ...
                    <TableBody>
                      {evidence.map((r) => (
                        <TableRow key={r.name}>
                          ...
                          <TableCell className="text-right">
                            <Button variant="outline" size="sm" className="h-8 rounded-lg bg-transparent" onClick={() => toast.info("Evidence request coming soon")}>
                              Request
                            </Button>
                          </TableCell>
                        </TableRow>
