...
3. Configure Claude Desktop with the `mcp-remote` bridge (see [AI Platform Guide](AI_GUIDE.md#option-3-remote-connection-mcp-proxy))
...
See the [AI Platform Guide](AI_GUIDE.md) for full setup instructions.
