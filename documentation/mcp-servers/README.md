...
RiskReady Community Edition exposes 8 MCP (Model Context Protocol) servers that allow AI assistants (Claude Code, Claude Desktop, etc.) to query and propose mutations against the GRC platform.
...
3. Human reviews the proposal in the AI Action Queue (`/settings/mcp-approvals`)
